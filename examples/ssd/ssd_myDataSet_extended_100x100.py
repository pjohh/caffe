...
# in percent %
min_ratio = 10 # for small objects, if objects are generally bigger use 0.2 or more?!
max_ratio = 95
...
min_sizes = [min_dim * 7 / 100.] + min_sizes # for overall bigger objects use 10/100
max_sizes = [[]] + max_sizes
