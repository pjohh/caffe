...
train_data = "examples/robot_dataset/robot_dataset_train_lmdb"
# The database file for testing data
test_data = "examples/robot_dataset/robot_dataset_val_lmdb"
...
job_name = "SSD_{}_3%".format(resize)
# The name of the model. Modify it if you want.
model_name = "VGG_robot_dataset_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/VGGNet/robot_dataset/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/VGGNet/robot_dataset/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/VGGNet/robot_dataset/{}".format(job_name)
# Directory which stores the detection results.
output_result_dir = "{}/data/robot_dataset/results/{}/Main".format(os.environ['HOME'], job_name)
...
name_size_file = "data/robot_dataset/val_name_size.txt"
# The pretrained model. We use the Fully convolutional reduced (atrous) VGGNet.
pretrain_model = "models/VGGNet/VGG_ILSVRC_16_layers_fc_reduced.caffemodel"
# Stores LabelMapItem.
label_map_file = "data/robot_dataset/labelmap.prototxt"
