...
train_data = "examples/myDataSet_full/myDataSet_full_train_lmdb"
# The database file for testing data
test_data = "examples/myDataSet_sbc/myDataSet_sbc_val_lmdb"
...
job_name = args.image_size
# The name of the model. Modify it if you want.
model_name = "VGG_myDataSet_full_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/VGGNet/myDataSet_full/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/VGGNet/myDataSet_full/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/VGGNet/myDataSet_full/{}".format(job_name)
# Directory which stores the detection results.
output_result_dir = "{}/data/myDataSet_full/results/{}/Main".format(os.environ['HOME'], job_name)
...
name_size_file = "data/myDataSet_sbc/val_name_size.txt"
# The resume model.
pretrain_model = "{}_iter_{}.caffemodel".format(snapshot_prefix, max_iter)
# Stores LabelMapItem.
label_map_file = "data/myDataSet_full/labelmap.prototxt"
