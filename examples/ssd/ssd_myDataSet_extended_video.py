...
video_file = "/home/pjoh/data/DLR_SpaceBot_Camp_2015_Videomaterial/SBC_2015_Domecams_chemnitz.mp4"
...
save_dir = "models/VGGNet/myDataSet_extended/{}_webcam".format(job_name)
...
job_dir = "jobs/VGGNet/myDataSet_extended/{}_webcam".format(job_name)
