...
train_data = "examples/myDataSet_extended/myDataSet_extended_train_humans_lmdb"
...
model_name = "VGG_myDataSet_extended_humans_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/VGGNet/myDataSet_extended_humans/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/VGGNet/myDataSet_extended_humans/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/VGGNet/myDataSet_extended_humans/{}".format(job_name)
# Directory which stores the detection results.
output_result_dir = "{}/data/{}/Main".format(os.environ['HOME'], model_name)
