...
# Stores LabelMapItem.
label_map_file = "data/{}/labelmap.prototxt".format(args.dataset)
...
model_name = "VGG_{}_{}".format(args.dataset, job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/VGGNet/{}/{}_webcam".format(args.dataset, job_name)
# Directory which stores the snapshot of trained models.
snapshot_dir = "models/VGGNet/{}/{}".format(args.dataset, job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/VGGNet/{}/{}_webcam".format(args.dataset, job_name)
