...
snapshot_dir = "models/VGGNet/myDataSet/SSD_300x300"
...
for file in os.listdir(snapshot_dir):
  if file.endswith(".caffemodel"):
    ...
    iter = int(basename.split("{}_iter_".format("VGG_myDataSet_SSD_300x300"))[1])
    if iter > max_iter:
      max_iter = iter
...
# load model
model_def = 'models/VGGNet/myDataSet/SSD_300x300/deploy.prototxt'
model_weights = 'models/VGGNet/myDataSet/SSD_300x300/VGG_myDataSet_SSD_300x300_iter_{}.caffemodel'.format(max_iter)
